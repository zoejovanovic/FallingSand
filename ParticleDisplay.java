// Do not edit
// Adapted from Nifty's SandDisplay.java 
...
public class ParticleDisplay extends JComponent implements MouseListener,
  MouseMotionListener, ActionListener, ChangeListener
{
  ...
  public ParticleDisplay(String title, int numRows, int numCols, ArrayList<String> classes)
  {
    String[] buttonNames = new String[classes.size()];
    System.out.println(classes);
    for (int i=0; i<classes.size(); i++) {
      buttonNames[i] = classes.get(i);
    }
  ...
  public void setColor(int x, int y, Color color)
  {
    ...
    g.setColor(color);
    g.fillRect(x * cellSize, (numRows - (y +1)) * cellSize, cellSize, cellSize);
  }
